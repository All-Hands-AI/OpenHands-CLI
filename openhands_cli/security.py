...
class SecurityAnalyzer:
    ...
    def analyze_file_operation(self, operation: str, file_path: str) -> ActionSecurityRisk:
    ...
    def analyze_action(self, action_type: str, action_data: Dict[str, Any]) -> ActionSecurityRisk:
