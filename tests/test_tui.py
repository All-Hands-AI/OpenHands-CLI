...
from openhands_cli.tui import CommandCompleter, COMMANDS


class TestCommandCompleter:
    """Test the CommandCompleter class."""

    def test_command_completion_with_slash(self):
    ...
    def test_command_completion_partial_match(self):
    ...
    def test_command_completion_no_slash(self):
    ...
    def test_command_completion_no_match(self):
    ...
    def test_command_completion_styling(self):
