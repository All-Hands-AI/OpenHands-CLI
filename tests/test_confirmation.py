...
class TestSecurityAnalyzer:
    ...
    def test_analyze_high_risk_commands(self) -> None:
        ...
        for command in high_risk_commands:
            ...
            assert risk == ActionSecurityRisk.HIGH, (
                f"Command '{command}' should be HIGH risk"
            )

    def test_analyze_medium_risk_commands(self) -> None:
        ...
        for command in medium_risk_commands:
            ...
            assert risk == ActionSecurityRisk.MEDIUM, (
                f"Command '{command}' should be MEDIUM risk"
            )

    def test_analyze_low_risk_commands(self) -> None:
        ...
        for command in low_risk_commands:
            ...
            assert risk == ActionSecurityRisk.LOW, (
                f"Command '{command}' should be LOW risk"
            )

    def test_analyze_file_operations(self) -> None:
        ...
        for operation, path in high_risk_cases:
            ...
            assert risk == ActionSecurityRisk.HIGH, (
                f"Operation '{operation}' on '{path}' should be HIGH risk"
            )
        ...
        for operation, path in medium_risk_cases:
            risk = self.analyzer.analyze_file_operation(operation, path)
            assert risk == ActionSecurityRisk.MEDIUM, (
                f"Operation '{operation}' on '{path}' should be MEDIUM risk"
            )
        ...
        for operation, path in low_risk_cases:
            risk = self.analyzer.analyze_file_operation(operation, path)
            assert risk == ActionSecurityRisk.LOW, (
                f"Operation '{operation}' on '{path}' should be LOW risk"
            )

    def test_analyze_action_bash(self) -> None:
    ...
    def test_analyze_action_file_editor(self) -> None:
...
class TestConfirmationMode:
    ...
    def test_always_confirm_mode(self) -> None:
    ...
    def test_never_confirm_mode(self) -> None:
    ...
    def test_auto_highrisk_mode(self) -> None:
    ...
    def test_set_mode_resets_flags(self) -> None:
...
class TestConfirmationIntegration:
    ...
    def test_analyze_action_risk(self) -> None:
        ...
        risk = analyze_action_risk(
            "str_replace_editor", {"command": "view", "path": "file.txt"}
        )
        assert risk == ActionSecurityRisk.LOW

    @patch("openhands_cli.confirmation.print_formatted_text")
    def test_display_risk_warning(self, mock_print: Any) -> None:
