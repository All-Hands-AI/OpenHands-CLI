...
class TestMainEntryPoint:
    ...
    def test_main_starts_agent_chat_directly(self, mock_run_agent_chat):
    ...
    @patch('openhands_cli.agent_chat.main')
    def test_main_handles_import_error(self, mock_run_agent_chat):
    ...
    @patch('openhands_cli.agent_chat.main')
    def test_main_handles_keyboard_interrupt(self, mock_run_agent_chat):
    ...
    @patch('openhands_cli.agent_chat.main')
    def test_main_handles_eof_error(self, mock_run_agent_chat):
    ...
    @patch('openhands_cli.agent_chat.main')
    def test_main_handles_general_exception(self, mock_run_agent_chat):
